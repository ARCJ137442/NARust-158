...
mod tests {
    ...
    //     #[test]
    //     fn test_sqrt_usize_floor() {
    //         macro_rules! test_sqrt_usize_floor {
    //             {
    //                 $($square:expr => $root:expr)*
    //             } => {
    //                 $(
    //                     assert_eq!(sqrt_usize_floor($square), $root, "wrong when sqrt_usize_floor {}", $square);
    //                 )*
    //             };
    //         }
    //         test_sqrt_usize_floor! {
    //             0 => 0
    //             1 => 1
    //             2 => 1
    //             3 => 1
    ...
    //         macro_rules! test_range_capacity {
    //             {
    //                 $($capacity:expr => $range:expr)*
    //             } => {
    //                 $(
    //                     assert_eq!(range_from_capacity::<$capacity>(), $range, "wrong when range_from_capacity from {}", $capacity);
    //                     assert_eq!($capacity, capacity_from_range::<$range>(), "wrong when capacity_from_range from {}", $range);
    //                 )*
    //             };
    //         }
    //         test_range_capacity! {
